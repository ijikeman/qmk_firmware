 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | '/\  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | LANG | Alt  | GUI  |Lower |SPC/MS|BS/Shif|Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_BASE] = KEYMAP( \
  ...
  KC_ESC,  TD(TD_LANG), KC_LALT, KC_LGUI, TD(TD_LOWR), LT(_MOUSE, KC_SPC),  LT(_SHIF ,KC_BSPC), TD(TD_RAIS), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT \
),
...
[_MOUSE] = KEYMAP( \
  _______, LGUI(KC_R), M_OSX_RETURN, KC_MS_U, M_OSX_FORWARD, _______, KC_F7,  KC_F8,   KC_F9,  KC_F10, KC_F11, KC_F12, \
  _______, KC_BTN1, KC_MS_L, KC_MS_D, KC_MS_R, M_OSX_ZOOMOUT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,   _______, _______, \
  _______, KC_BTN2, KC_WH_D, M_OSX_MISSION, KC_WH_U, M_OSX_ZOOMIN, _______, LGUI(KC_C), LGUI(KC_X), LGUI(KC_V), _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______ \
),

// SHIFTIT LAYER
[_SHIF] = KEYMAP( \
  _______, _______, M_SH_LU, M_SH_U, M_SH_RU, _______,   KC_F7,  KC_F8,   KC_F9,  KC_F10, KC_F11, KC_F12, \
