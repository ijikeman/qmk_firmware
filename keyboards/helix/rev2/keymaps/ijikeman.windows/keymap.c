...
SFT_T(KC_ESC), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT, \
      KC_NO,   KC_NO,   KC_NO,KC_LALT,KC_LGUI,LT(_LOWER,KC_SPC),LT(_LOWER,KC_SPC),LT(_RAISE,KC_BSPC),LT(_RAISE,KC_BSPC),LED,M_LANG,KC_NO,KC_NO,KC_NO \
      ),
